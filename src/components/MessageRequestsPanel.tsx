  ...
  return (
    <div className="absolute inset-0 z-30 flex flex-col bg-white dark:bg-zinc-900">
      ...
      <p className="px-4 py-3 text-sm text-slate-400">
        Ces personnes ne sont pas dans vos contacts. Accepter fait entrer la conversation dans
        votre liste.
      </p>
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <p className="px-6 py-10 text-center text-sm text-slate-400">Aucune demande.</p>
        ) : (
          <ul>
            {items.map((c) => {
